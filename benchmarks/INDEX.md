...
| `benchmarks/single_stage_profile_m4.json` | `benchmarks/single_stage_profile.py` | `50814b65` | 2026-09-13 | `examples/optimization/single_stage_optimization.py`, `examples/three-methods-benchmark/single_stage_optimization.py`, `plan.md` |
