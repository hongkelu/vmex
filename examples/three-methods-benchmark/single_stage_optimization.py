...
IOTA_FLOOR = 0.19  # minimum |iota| over the profile
ASPECT_LIMIT = 5.0  # maximum aspect ratio
...
# Use the requested plasma limits in both optimization and final checks.
# Normal-field and curvature thresholds retain the example's tighter values.
IOTA_CONSTRAINT = 0.2
ASPECT_CONSTRAINT = 5.0
