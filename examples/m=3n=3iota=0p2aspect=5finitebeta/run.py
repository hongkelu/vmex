...
def main():
    ...
    def checkpoint():
        ...
        data = dict(
            schema_version=np.asarray("vmex.iota02-aspect5-finitebeta-accepted/v1"),
    ...
    try:
        ...
        provenance = dict(
            ...
            source_sha256={
                ...
                **{"case/" + str(f.relative_to(CASE)): sha256(f) for f in CASE.rglob("*.py") if "runs" not in f.parts},
            },
        )
        ...
        write(
            ...
            dict(
                ...
                targets_source="explicit user targets: iota=0.2, aspect=5, B0=+5.1 T"
                if resume is None
