...
def test_all_radial_stages_and_free_boundary_keep_48x40():
 ...
 inp=rotating_ellipse(ref,major_radius=11.067033897730942,aspect=5,t=.25188920340834803,handedness=-1,phiedge=91.09117631931035)
 ...
 for n in ('ncurr','curtor','pres_scale','pmass_type','am','am_aux_s','am_aux_f','pcurr_type','ac','ac_aux_s','ac_aux_f'):
