...
fit = json.loads((ROOT / "coils_nestor/summary.json").read_text())
...
assert inp.lfreeb
raw = json.loads((ROOT / "coils_nestor/coils_candidate.json").read_text())
...
summary = dict(
    ...
    coil_sha256=sha(ROOT / "coils_nestor/coils_candidate.json"),
